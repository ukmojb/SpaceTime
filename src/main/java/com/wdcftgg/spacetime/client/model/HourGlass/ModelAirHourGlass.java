 ...
 *
 * @Author : wdcftgg
 * @create 2023/6/22 10:37
 */
public class ModelAirHourGlass extends AnimatedGeoModel {
    ...
    {
        return new ResourceLocation(SpaceTime.MODID, "textures/block/blockairhourglass.png");
    }
}