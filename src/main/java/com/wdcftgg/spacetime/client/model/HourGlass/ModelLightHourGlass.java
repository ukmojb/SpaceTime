 ...
 *
 * @Author : wdcftgg
 * @create 2023/6/22 10:43
 */
public class ModelLightHourGlass extends AnimatedGeoModel {
    ...
    {
        return new ResourceLocation(SpaceTime.MODID, "textures/block/blocklighthourglass.png");
    }
}