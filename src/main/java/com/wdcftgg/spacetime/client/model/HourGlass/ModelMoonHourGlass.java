 ...
 *
 * @Author : wdcftgg
 * @create 2023/6/22 10:42
 */
public class ModelMoonHourGlass extends AnimatedGeoModel {
    ...
    {
        return new ResourceLocation(SpaceTime.MODID, "textures/block/blockmoonhourglass.png");
    }
}