 ...
 *
 * @Author : wdcftgg
 * @create 2023/10/1 15:53
 */
public class RenderEndGatewayImitate extends TileEntitySpecialRenderer<EndGatewayImitateEntity>
{
    ...
    public RenderEndGatewayImitate() {
    }

    public void render(EndGatewayImitateEntity te, double x, double y, double z, float partialTicks, int destroyStage, float p_192841_10_) {
        ...
        for(int j = 0; j < i; ++j) {
            ...
            vertexbuffer.pos(x, y, z + 1.0).color(f3, f4, f5, 1.0F).endVertex();
            vertexbuffer.pos(x + 1.0, y, z + 1.0).color(f3, f4, f5, 1.0F).endVertex();
            vertexbuffer.pos(x + 1.0, y + 1.0, z + 1.0).color(f3, f4, f5, 1.0F).endVertex();
            vertexbuffer.pos(x, y + 1.0, z + 1.0).color(f3, f4, f5, 1.0F).endVertex();
            vertexbuffer.pos(x, y + 1.0, z).color(f3, f4, f5, 1.0F).endVertex();
            vertexbuffer.pos(x + 1.0, y + 1.0, z).color(f3, f4, f5, 1.0F).endVertex();
            vertexbuffer.pos(x + 1.0, y, z).color(f3, f4, f5, 1.0F).endVertex();
            ...
            vertexbuffer.pos(x + 1.0, y, z + 1.0).color(f3, f4, f5, 1.0F).endVertex();
            vertexbuffer.pos(x, y, z + 1.0).color(f3, f4, f5, 1.0F).endVertex();
            vertexbuffer.pos(x, y + (double)f, z + 1.0).color(f3, f4, f5, 1.0F).endVertex();
            vertexbuffer.pos(x + 1.0, y + (double)f, z + 1.0).color(f3, f4, f5, 1.0F).endVertex();
            vertexbuffer.pos(x + 1.0, y + (double)f, z).color(f3, f4, f5, 1.0F).endVertex();
