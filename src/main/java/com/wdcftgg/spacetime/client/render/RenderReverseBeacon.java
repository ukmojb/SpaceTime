...
public class RenderReverseBeacon extends TileEntitySpecialRenderer<ReverseBeaconEntity>
{
    public static final ResourceLocation TEXTURE_BEACON_BEAM = new ResourceLocation("textures/entity/beacon_beam.png");

    public void render(ReverseBeaconEntity te, double x, double y, double z, float partialTicks, int destroyStage, float alpha)
    {
    ...
    public void renderBeacon(double x, double y, double z, double partialTicks, double textureScale, List<ReverseBeaconEntity.BeamSegment> beamSegments, double totalWorldTime)
    {
...
//            System.out.println(beamSegments.size() + "--render");
            for (int j = 0; j < beamSegments.size(); ++j)
            {
//                System.out.println(beamSegments.get(i).getHeight() + "render");
                j = j * -1;
                ReverseBeaconEntity.BeamSegment tileentitybeacon$beamsegment = beamSegments.get(j);
...
//        GlStateManager.translate(0, -i, 0);
    ...
    @Override
    public boolean isGlobalRenderer(ReverseBeaconEntity te)
    {
        return true;
    }
}