package com.wdcftgg.spacetime.entity.projectiles;
...
public class EntityIdlProjectile extends Entity implements IProjectile {
    ...
    protected EntityIdlProjectile(World worldIn, ProjectileArgs args) {
        super(worldIn);
        this.args = args;
        //SpaceTime.Log("bullet created %s, args = %s", getUniqueID(), this.args);
    }
...
//    }
    ...
    {
        //SpaceTime.Log("Bullet pos update:%s", getPositionEyes(0));
    ...
    protected boolean isFireballFiery()
    {
        if (args == null)
        {
            //SpaceTime.LogWarning("Args not found for bullet");
            return false;
        }
        return args.burning;
    }
...
//    }
    ...
    {
        //SpaceTime.Log("bullet impact %s", getUniqueID());
