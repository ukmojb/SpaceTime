...
public class TimeAIAttackMelee extends EntityAIBase
{
    ...
    public TimeAIAttackMelee(EntityCreature creature, double speedIn, boolean useLongMemory)
    {
    ...
    {
        if (this.attacker.isInWater() || this.attacker.isInLava()) {
            this.attacker.getNavigator().setPath(this.path, this.speedTowardsTarget);
        } else {
            this.attacker.getNavigator().setPath(this.path, this.speedTowardsTarget * 1.5D);
        }
