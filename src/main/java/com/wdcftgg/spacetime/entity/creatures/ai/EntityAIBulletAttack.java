...
//        }
    ...
    public void updateTask()
    {
        ...
        {
//            SpaceTime.LogWarning("cant see");
            this.ticksLookingAtTarget = 0;
        }

//        SpaceTime.Log(String.format("Looking ticks = %d", ticksLookingAtTarget ));
//        SpaceTime.Log(String.format("dist = %.2f/%.2f", targetDistance, maxRange));
