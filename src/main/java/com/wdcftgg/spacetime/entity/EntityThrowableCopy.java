...
public abstract class EntityThrowableCopy extends Entity implements IProjectile
{
    ...
    public EntityThrowableCopy(World worldIn, double x, double y, double z, EntityLivingBase throwerIn)
    {
        this(worldIn);
        this.setPosition(x, y, z);
    ...
    public void onUpdate()
    {
        ...
        for (int i = 0; i < list.size(); ++i)
        {
            ...
            if (entity1.canBeCollidedWith())
            {
                ...
                {
                    flag = false;
                    AxisAlignedBB axisalignedbb = entity1.getEntityBoundingBox().grow(0.8D);
        ...
        if (raytraceresult != null && ignoreTime <= 0)
        {
