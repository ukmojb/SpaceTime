...
public class Category implements IRecipeCategory<Wrapper> {
    public static final ResourceLocation BACKGROUND = new ResourceLocation(SpaceTime.MODID, "textures/gui/timecrackjei.png");
    public static final ResourceLocation ICON = new ResourceLocation(SpaceTime.MODID, "textures/gui/timecrackicon.png");
    ...
    public String getUid() {
        return SpaceTime.MODID + "timecrack";
    }

    @Override
    public String getTitle() {
        return I18n.format(SpaceTime.MODID + ".timecrack.category");
    }
