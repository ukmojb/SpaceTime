...
public interface ISpace
{
    ...
    public int addSpace(ItemStack is, int timeSand);

    public int removeSpace(ItemStack is, int timeSand);
     ...
     */
    public int removeSpaceFromInventory(IInventory inventory, int timeSand);
