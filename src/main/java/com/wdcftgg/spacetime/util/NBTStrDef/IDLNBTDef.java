package com.wdcftgg.spacetime.util.NBTStrDef;
...
public class IDLNBTDef {
	...
	public static final String NAME_OFF= "spacetime.shared.off";
	public static final String NAME_ON= "spacetime.shared.on";
	...
	public static final String STARTER_KIT_VERSION_TAG = "last_starter_kit_" + SpaceTime.MODID;
	...
	//gua socket
	public static final String GUA_NO_FREE_SOCKET_DESC = "spacetime.gua_enhance_no_free.desc";
	public static final String GUA_FREE_SOCKET_DESC = "spacetime.gua_enhance_free.desc";
	public static final String GUA_TOTAL_SOCKET_DESC = "spacetime.gua_enhance_total.desc";
	public static final String GUA_N_A_DESC = "spacetime.gua_not_applicable.desc";
	...
	public static final String KILL_COUNT_DESC = "spacetime.kill_count.desc";
