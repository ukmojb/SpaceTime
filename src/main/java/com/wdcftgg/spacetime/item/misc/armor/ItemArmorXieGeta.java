package com.wdcftgg.spacetime.item.misc.armor;

import java.util.List;

import com.wdcftgg.spacetime.item.IGuaEnhance;
import com.wdcftgg.spacetime.item.ItemArmorBase;
...
public class ItemArmorXieGeta extends ItemArmorBase implements IGuaEnhance {
    ...
    public static void onCreatureHurt(LivingHurtEvent evt) {
        if (evt.isCanceled() || evt.getSource() != DamageSource.FALL) {
            //SpaceTime.Log("Xie Geta wrong type");
            return;
        }
        ...
        if (onFoot.getItem() instanceof ItemArmorXieGeta)
        {
            ...
            //SpaceTime.Log("Xie Geta dmg reduction:%s", reduction);
