...
import com.wdcftgg.spacetime.item.IGuaEnhance;
import com.wdcftgg.spacetime.item.ItemSwordBase;
import com.wdcftgg.spacetime.util.CommonDef;
import com.wdcftgg.spacetime.util.IDLGeneral;
import com.wdcftgg.spacetime.util.IDLSkillNBT;
...
//    public com.wdcftgg.spacetime.item.skills.martial.BuffTuple GetWaterBuff(ItemStack stack)
//    {
//        int water = GetGuaEnhance(stack, 2);
//        return new com.wdcftgg.spacetime.item.skills.martial.BuffTuple(water / 4, TICK_PER_SECOND * water * 2);
//    }
//
//    public com.wdcftgg.spacetime.item.skills.martial.BuffTuple GetMountainBuff(ItemStack stack)
//    {
//        int gua = GetGuaEnhance(stack, 4);
//        return new com.wdcftgg.spacetime.item.skills.martial.BuffTuple(gua / 4, TICK_PER_SECOND * gua * 2);
//    }
//
