...
import com.wdcftgg.spacetime.entity.projectiles.ProjectileArgs;
import com.wdcftgg.spacetime.gui.ModGuiElementLoader;
import com.wdcftgg.spacetime.util.NBTStrDef.IDLNBTUtil;
...
public class ItemDebug extends ItemBase{
    ...
    public void addInformation(ItemStack stack, World world, List<String> tooltip, ITooltipFlag flag) {
        ...
        //tooltip.add(I18n.format("spacetime.gua_enhance_total.desc", IDLSkillNBT.GetGuaEnhanceTotal(stack)));
...
//    }
    ...
    void TestEnchant(World worldIn, EntityPlayer playerIn, EnumHand handIn)
    {
        ...
        for (Enchantment enchantment : Enchantment.REGISTRY)
        {
            ...
            SpaceTime.Log("[%s]Lv %d to %d, canApplyAtEnchantingTable = %s, judgement[%s,%s,%s]",
                    enchantment.getName(),
            ...
            if (judge1 && judge2 || judge3)
            {
                ...
                {
                    SpaceTime.Log("[%s] Lv.%d available range = %d to %d", enchantment.getName(), i,
                    ...
                    {
                        SpaceTime.Log("[%s] successfully elected", enchantment.getName());
                        break;
                    }
                }
            }
    ...
    public ActionResult<ItemStack> onItemRightClick(World worldIn, EntityPlayer playerIn, EnumHand handIn) {
        ...
        if (index == 2 && !worldIn.isRemote) {
            ...
            SpaceTime.Log("bullet pos = %s", bullet.getPosition());
        ...
        if (!worldIn.isRemote)
        {
            ...
            if (index == 3)
            {
                ...
                playerIn.openGui(SpaceTime.instance, ModGuiElementLoader.GUI_RESEARCH, worldIn, pos.getX(), pos.getY(), pos.getZ());
            }
            //else

            //todo: optimize
            //playerIn.openGui(SpaceTime.instance, ModGuiElementLoader.GUI_DEMO, worldIn, pos.getX(), pos.getY(), pos.getZ());
...
//            }
        ...
        //SpaceTime.Log("NBT len = %d", IDLNBTUtil.GetString(stack, "TEST", "").length());
