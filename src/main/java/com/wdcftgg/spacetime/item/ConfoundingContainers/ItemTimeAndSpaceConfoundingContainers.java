 ...
 */
public class ItemTimeAndSpaceConfoundingContainers extends ItemBase implements ITimeSand, ISpace, IHasModel, ITimeSandSupplier {
    ...
    {
        return STItems.TIMEANDSPACECONFOUNDINGCONTAINERS;
    }
}
