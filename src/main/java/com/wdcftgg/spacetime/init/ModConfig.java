...
public class ModConfig {
    ...
    @Config.LangKey("configgui.spacetime.category.Menu0.GeneralConf")
    @Config.Comment("SpaceTime general config.")
    public static final GeneralConf GeneralConf = new GeneralConf();

    public static class GeneralConf {
//        @Config.LangKey("spacetime.conf.general.welcome")
//        @Config.Comment("The text shown when a player logs in. Can be a key or a string.")
//        public String WELCOME_MSG = "spacetime.msg.welcome";
    }

    @Config.LangKey("configgui.spacetime.category.Menu0.DebugConf")
    ...
    @Config.LangKey("configgui.spacetime.category.Menu0.SpawnConf")
