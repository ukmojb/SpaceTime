 ...
 */
public class MoonHourGlassEntity extends TileEntity implements IAnimatable {
    ...
    {
        data.addAnimationController(new AnimationController(this, "moonhourglass", 0, this::predicate));
    }
    ...
    public void readFromNBT(NBTTagCompound data) {
        ...
        this.moon = data.getInteger("moon");
    }
}
