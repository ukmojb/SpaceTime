 ...
 */
public class EarthHourGlassEntity extends TileEntity implements IAnimatable {
    ...
    {
        data.addAnimationController(new AnimationController(this, "earthhourglass", 0, this::predicate));
    }
    ...
    public void readFromNBT(NBTTagCompound data) {
        ...
        this.earth = data.getInteger("earth");
    }
}
