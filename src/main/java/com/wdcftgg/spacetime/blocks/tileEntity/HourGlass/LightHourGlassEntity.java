 ...
 */
public class LightHourGlassEntity extends TileEntity implements IAnimatable {
    ...
    {
        data.addAnimationController(new AnimationController(this, "lighthourglass", 0, this::predicate));
    }
    ...
    public void readFromNBT(NBTTagCompound data) {
        ...
        this.light = data.getInteger("light");
    }
}
